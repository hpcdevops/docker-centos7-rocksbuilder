--- /opt/rocks/lib/python2.6/site-packages/rocks/commands/create/mirror/__init__.py	2017-04-21 10:33:29.036573584 -0700
...
+	<example cmd='create mirror http://mirrors.kernel.org/centos/7.0/updates/x86_64/Packages rollname=CentOS-Updates version=7.0 release=2019.01.29'>
...
+	http://mirrors.kernel.org/centos/7.0/updates/x86_64/Packages and will create
+	a Roll ISO image named 'CentOS-Updates-7.0-2019.01.29.x86_64.disk1.iso'.
 	</example>
 	"""
